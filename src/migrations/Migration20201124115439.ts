...
export class Migration20201124115439 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table `request` add index `request_receiver_id_index`(`receiver_id`);');
    ...
    this.addSql('alter table `request` add constraint `request_receiver_id_foreign` foreign key (`receiver_id`) references `user` (`id`) on update cascade;');
